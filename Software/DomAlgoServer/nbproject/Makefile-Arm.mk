...
${OBJECTDIR}/src/Synapsis/Core/SynapsisBase.o: src/Synapsis/Core/SynapsisBase.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Synapsis/Core/SynapsisBase.o src/Synapsis/Core/SynapsisBase.cpp

${OBJECTDIR}/src/Synapsis/Log/Log.o: src/Synapsis/Log/Log.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Synapsis/Log
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Synapsis/Log/Log.o src/Synapsis/Log/Log.cpp

${OBJECTDIR}/src/Synapsis/Sensor/Sensor.o: src/Synapsis/Sensor/Sensor.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Synapsis/Sensor
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Synapsis/Sensor/Sensor.o src/Synapsis/Sensor/Sensor.cpp

${OBJECTDIR}/src/Synapsis/Sensor/SimpleSwitch.o: src/Synapsis/Sensor/SimpleSwitch.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Synapsis/Sensor
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Synapsis/Sensor/SimpleSwitch.o src/Synapsis/Sensor/SimpleSwitch.cpp
